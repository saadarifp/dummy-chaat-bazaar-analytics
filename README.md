...
- **Day 6** — Window functions (`day6_window_functions.sql`: ranking, running totals, LAG, deviation from branch average); open-ended CEO analysis with confidence-rated findings (`day6_ceo_analysis.md`); Entra ID/RBAC access model (`day6_access_control.md`).
